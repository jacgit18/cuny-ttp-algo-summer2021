...
Class methods to Leverage & Rule out:
...
var combinationSum = function(candidates, target) {
    ...
    let combo = [];
      ...
      for (let i = 0; i < candidates.length; ++i) {
          ...
          if (testcaseZero) {combo.push(candidates[i]);}
          let testcaseOne = sum !== target || sum < target;
    ...
    // }
      ...
      let testcaseTwo = candidates.length < 1 && candidates[0] > target;
    if(testcaseTwo){
        return [];
    }
      return combo
