...
var Thenums = [1, 2, 3, 4]; // const ProductofArray = (nums) => {
//   let MyN = nums.length;
...
var ProductofArray2 = function ProductofArray2(nums) {
  var MyN = nums.length;
  var Myleft = new Array(MyN);
  var Myright = new Array(MyN);
  var MyOutput = new Array(MyN);
  Myleft[0] = 1;
  Myright[MyN - 1] = 1;
  console.log("Forward ");
  var index = 1;
  nums.map(function (left, index, myN) {
